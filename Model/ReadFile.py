    ...
    for root, dirs, files in os.walk(
        ...
        for file in files:
           ...
           #print(dir())
            ...
            print(end - start)
            print("finished doc #" + str(counter))
    print(counter)
